...
line1_bw = "Welcome to CircuitPython Day!"
...
lines = [
    b"Welcome to CircuitPython Day 2022!",
    b"Welcome Dan, Jeff, Kattni, and Tim",
    b"1pm EST Maker Melissa CircuitPython Stream",
    b"2pm EST CircuitPython Themed Show & Tell  ",
]
